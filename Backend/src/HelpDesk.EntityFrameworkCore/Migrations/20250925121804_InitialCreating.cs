    ...
    public partial class InitialCreating : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FaultGroups", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssuesStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    dep_name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IssueCategory = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Issues_IssuesStatuses_IssueStatusId",
                        column: x => x.IssueStatusId,
                        principalTable: "IssuesStatuses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Issues_PriorityLevels_PriorityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WrongNumber = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    RightNumber = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    TerminalNumber = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Sum = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CancelledSum = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Subscriber = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    TenantId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CallCenterIssues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CallCenterIssues_Issues_IssuesId",
                        column: x => x.IssuesId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CallCenterIssues_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CallCenterIssues_SubCategories_SubCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssuesAdministrators", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IssuesAdministrators_Issues_IssueId",
                        column: x => x.IssueId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IssuesAdministrators_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssuesAssignees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IssuesAssignees_Issues_IssueId",
                        column: x => x.IssueId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IssuesAssignees_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IssueId = table.Column<long>(type: "bigint", nullable: false),
                    ClaimKey = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ClaimValue = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssuesClaims", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IssuesClaims_Issues_IssueId",
                        column: x => x.IssueId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IssueId = table.Column<long>(type: "bigint", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(max)", maxLength: 2000, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_IssuesHistory_Users_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssuesObservers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IssuesObservers_Issues_IssueId",
                        column: x => x.IssueId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IssuesObservers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IssuesId = table.Column<long>(type: "bigint", nullable: false),
                    AgentFullName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    AgentNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Equipment = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    SerialNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IssueDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    WorkAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ReplacementParts = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    TenantId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RepairIssues_Issues_IssuesId",
                        column: x => x.IssuesId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "TechDepartmentIssues",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IssuesId = table.Column<long>(type: "bigint", nullable: false),
                    TerminalNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    TerminalName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    AgentId = table.Column<long>(type: "bigint", nullable: false),
                    AgentNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    IssueDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IssueGroupId = table.Column<int>(type: "int", nullable: true),
                    TerminalLocation = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CityId = table.Column<int>(type: "int", nullable: true),
                    TenantId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechDepartmentIssues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TechDepartmentIssues_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_TechDepartmentIssues_FaultGroups_IssueGroupId",
                        column: x => x.IssueGroupId,
                        principalTable: "FaultGroups",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_TechDepartmentIssues_Issues_IssuesId",
                        column: x => x.IssuesId,
                        principalTable: "Issues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CallCenterIssues_IssuesId",
                table: "CallCenterIssues",
                column: "IssuesId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CallCenterIssues_ServiceId",
                table: "CallCenterIssues",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_CallCenterIssues_SubCategoryId",
                table: "CallCenterIssues",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssuesAdministrators_IssueId_UserId",
                table: "IssuesAdministrators",
                columns: new[] { "IssueId", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_IssuesAdministrators_UserId",
                table: "IssuesAdministrators",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_IssuesAssignees_IssueId_UserId",
                table: "IssuesAssignees",
                columns: new[] { "IssueId", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_IssuesAssignees_UserId",
                table: "IssuesAssignees",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_IssuesClaims_IssueId",
                table: "IssuesClaims",
                column: "IssueId");

            migrationBuilder.CreateIndex(
                name: "IX_IssuesComments_IssueId_CreationTime",
                table: "IssuesComments",
                columns: new[] { "IssueId", "CreationTime" });

            migrationBuilder.CreateIndex(
                name: "IX_IssuesHistory_CreatedBy",
                table: "IssuesHistory",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_IssuesHistory_IssueId_FieldName_CreationTime",
                table: "IssuesHistory",
                columns: new[] { "IssueId", "FieldName", "CreationTime" });

            migrationBuilder.CreateIndex(
                name: "IX_IssuesObservers_IssueId_UserId",
                table: "IssuesObservers",
                columns: new[] { "IssueId", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_IssuesObservers_UserId",
                table: "IssuesObservers",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TechDepartmentIssues_CityId",
                table: "TechDepartmentIssues",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_TechDepartmentIssues_IssueGroupId",
                table: "TechDepartmentIssues",
                column: "IssueGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_TechDepartmentIssues_IssuesId",
                table: "TechDepartmentIssues",
                column: "IssuesId",
                unique: true);
