// tech-department-issues.service.ts
...
@Injectable()
export class TechDepartmentIssuesServiceProxy {
    ...
    get(id: number | undefined): Observable<IssuesDto> {
        let url_ = this.baseUrl + '/api/services/app/TechDepartmentIssues/Get?';
        if (id === null) {
    ...
    getAll(input: GetAllIssuesInput): Observable<IssuesDtoPagedResultDto> {
        let url_ = this.baseUrl + '/api/services/app/Issue/GetAllTechDepartmentIssues?';
