...
export class CategoriesComponent extends AppComponentBase implements OnInit, AfterViewInit {
    ...
    list(): void {
        ...
        this._categoryService
            ...
            .subscribe({
                next: (result: CategoryDtoPagedResultDto) => {
    ...
    showCreateOrEditCategoryDialog(id?: number): void {
        ...
        if (!id) {
            createOrEditCategoryDialog = this._modalService.show(CreateCategoryDialogComponent, {
                class: 'modal-lg',
            });
        } else {
            createOrEditCategoryDialog = this._modalService.show(EditCategoryDialogComponent, {
                class: 'modal-lg',
                initialState: {
                    id: id,
                },
    ...
    trackById(index: number, category: CategoryDto): number {
        return category.id;
    }
}