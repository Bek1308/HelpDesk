module.exports = {
  ...
  theme: {
    ...
    extend: {
      animation: {
        'floating-1': 'floating-1 7s ease-in-out infinite',
        'floating-2': 'floating-2 6s ease-in-out infinite',
        'floating-3': 'floating-3 8s ease-in-out infinite',
        'floating-4': 'floating-4 5s ease-in-out infinite',
      },
      keyframes: {
        'floating-1': {
      ...
      spacing: {
        'sidebar-width': '264px',
        'header-height': '80px',
        'footer-height': '80px',  // Increased header height
        'topbar-height': '60px',
      ...
      colors: {
        ...
        'scrollbar-light': '#3f4d67', // Light tema uchun scrollbar thumb
        'scrollbar-dark': '#a9b7d0',  // Dark tema uchun scrollbar thumb
